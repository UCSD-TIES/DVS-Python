...
# Github repo: https://github.com/svjharris/DVS

import cv

def Load():

    # You will need to change the line below to point to the file
    # you would like to test this module on
    image = cv.LoadImage('C:/Users/Shannon/Documents/GitHub/DVS/dallas.jpg')
