...
strcpy(report_filename,"John Doe");
strcpy(up_filename,"");
  ...
  case WM_COMMAND:
    switch (LOWORD(wParam))
	  ...
	  case IDB_REPORTS:
	    ...
	    if (_spawnlp(_P_NOWAIT,ExplorerPath,"explorer",ReportsPath,NULL) == -1)
...
VersionWnd=CreateWindow("BUTTON","Program Version",
		WS_CHILD | WS_VISIBLE | BS_MULTILINE | BS_CENTER | BS_PUSHBUTTON | BS_TEXT,
...
RunOKWnd=CreateWindow("BUTTON","OK",
		WS_CHILD | WS_VISIBLE | BS_MULTILINE | BS_CENTER | BS_PUSHBUTTON | BS_TEXT,
		30,320,150,32,MainWnd,(HMENU)IDB_RUN_OK,hInst,NULL);
RunCancelWnd=CreateWindow("BUTTON","Cancel",
		WS_CHILD | WS_VISIBLE | BS_MULTILINE | BS_CENTER | BS_PUSHBUTTON | BS_TEXT,
		210,320,150,32,MainWnd,(HMENU)IDB_RUN_CANCEL,hInst,NULL);
ReportNameWnd=CreateWindow("EDIT",report_filename,
		WS_CHILD | WS_VISIBLE | WS_BORDER | ES_AUTOHSCROLL,
		140,270,210,22,MainWnd,(HMENU)IDE_REPORT_NAME,hInst,NULL);
